...
void xyz_gradient(const RunConfig& run_config, Kokkos::View<double**, Kokkos::LayoutRight>& x_comps, 
	...
	Kokkos::parallel_for(Kokkos::RangePolicy(lb, ub), panel_gradient(x_comps, y_comps, z_comps, func_vals, xi_derivs_workspace, eta_derivs_workspace, 
							cubed_sphere_panels, run_config.interp_degree, lb));
}
