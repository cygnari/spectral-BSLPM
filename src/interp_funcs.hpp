...
template <class LayoutType> struct latlon_interp_host {
	...
	latlon_interp_host(Kokkos::View<double**, LayoutType, Kokkos::HostSpace>& data_, Kokkos::View<CubedSpherePanel*, Kokkos::HostSpace>& cubed_sphere_panels_, 
...
template <class LayoutType> void interp_to_latlon_host(const RunConfig& run_config, Kokkos::View<double**, LayoutType, Kokkos::HostSpace>& data, 
