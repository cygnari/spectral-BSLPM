...
struct bve_vel_panel_interaction {
    ...
    bve_vel_panel_interaction(Kokkos::View<double**, Kokkos::LayoutRight>& disp_x_, Kokkos::View<double**, Kokkos::LayoutRight>& disp_y_, 
    ...
    void operator()(const int i) const {
        ...
        double xi_s, eta_s, xi_t, eta_t, xyz_t[3], xyz_s[3], dp, gfcomp, x_s, y_s, z_s;
