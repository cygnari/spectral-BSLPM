...
void swe_vel_interactions(const RunConfig& run_config, Kokkos::View<double**, Kokkos::LayoutRight>& disp_x, Kokkos::View<double**, Kokkos::LayoutRight>& disp_y, 
    ...
    Kokkos::parallel_for(Kokkos::RangePolicy(lb, ub), swe_vel_panel_interaction(disp_x, disp_y, disp_z, target_pots_1, target_pots_2, target_pots_3, source_vals_vor, source_vals_div, interp_vals, cubed_sphere_panels, interaction_list, offset, run_config.kernel_eps));
    Kokkos::fence();
}
...
void swe_vel_interactions_ll(const RunConfig& run_config, Kokkos::View<double**, Kokkos::LayoutRight>& xcos, Kokkos::View<double**, Kokkos::LayoutRight>& ycos, 
    ...
    Kokkos::parallel_for(Kokkos::RangePolicy(lb, ub), swe_vel_panel_interaction_ll(
                            xcos, ycos, zcos, target_pots_1, target_pots_2, target_pots_3, vel_x, vel_y, vel_z, source_vals_vor, source_vals_div, 
...
void swe_vel_interactions_octo(const RunConfig& run_config, Kokkos::View<double**, Kokkos::LayoutRight>& xcos, Kokkos::View<double**, Kokkos::LayoutRight>& ycos, 
    ...
    Kokkos::parallel_for(Kokkos::RangePolicy(lb, ub), swe_vel_panel_interaction_octo(
    // Kokkos::parallel_for(Kokkos::RangePolicy(0, 1), swe_vel_panel_interaction_octo(
                            xcos, ycos, zcos, target_pots_1, target_pots_2, target_pots_3, vel_x, vel_y, vel_z, source_vals_vor, source_vals_div, 
                            vors, divs, area, leaf_panel_points, octo_sphere_panels, interaction_list, run_config.kernel_eps, run_config.interp_degree));
    Kokkos::fence();
}
