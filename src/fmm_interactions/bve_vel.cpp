...
void bve_vel_interactions(const RunConfig& run_config, Kokkos::View<double**, Kokkos::LayoutRight>& target_pots_1, 
    ...
    Kokkos::parallel_for(Kokkos::RangePolicy(lb, ub), bve_vel_panel_interaction(target_pots_1, target_pots_2, target_pots_3, source_vals, interp_vals, cubed_sphere_panels, interaction_list));
    Kokkos::fence();
}
